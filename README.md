...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aws-c-compression-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-c-compression-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add aws-c-compression
# for installing globally
pixi global install aws-c-compression
```
...
It is possible to list all of the versions of `aws-c-compression` available on your platform:
...
```
pixi search aws-c-compression --channel conda-forge
```
